...
public:
    ...
    void updateCellsCloud(const cvpr_tum::TsdfVolume& volume);
    ...
    void updateMesh(const cvpr_tum::TsdfVolume& volume);

    void renderScene(const cvpr_tum::TsdfVolume& volume, bool has_gpu = true);
